...
export default function StepTwo(
    ...
    const handleChange = (event: ChangeEvent)=> {
        ...
        console.log(name, value, {...formObject, name: value}, formVaidator(name, value));
            ...
            <form className="form-card">
                ...
                <label htmlFor='plan-arcade' className={'plan-label ' + `${formObject.plan == 'Arcade' ? 'checked': ''}`}>
                    ...
                    <div className="plan-caption">
                        ...
                        <span 
                            className={'font-bold text-md block ' + `${formObject.period != 'Yearly' ? 'opacity-0' : ''}`}
                        >2 months free</span>
                    </div>
                    <input 
                        type="radio" 
                ...
                <div className="period-selector">
                    ...
                    <input 
                        ...
                        />
                    <span className={'switch ' + `${formObject.period == 'Monthly' ? 'left': 'right'}`}>
